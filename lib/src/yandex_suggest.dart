...
class YandexSuggest {
  ...
  static Future<SuggestSessionResult> getSuggestions(
      {required String text,
      required BoundingBox boundingBox,
      required SuggestOptions suggestOptions}) async {
    final session = await _initSession();

    return session._getSuggestions(
        text: text, boundingBox: boundingBox, suggestOptions: suggestOptions);
  }
